...
import MoongetHeavy from '../assets/MOONGET_Heavy.blob'

function Text({ children, size = 1, left, right, top, bottom, color = "white", opacity = 1, height = 0.01, layers = 0, font = MoongetHeavy, ...props }) {
